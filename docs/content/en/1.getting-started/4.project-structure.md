...
::prose-note{to="/en/concepts/edition#landing-page"}
You can customize your landing page with Markdown (`content/index.md`) or create a custom Vue page (`app/pages/index.vue`). Learn more about landing page options.
::
