...
When [`subNavigation`](/en/concepts/configuration#sub-navigation) is enabled, Docus renders a secondary navigation bar below the header. To add custom content on the right side of this bar (e.g. a toggle, a badge), create a `components/AppHeaderBottomRight.vue` component.
