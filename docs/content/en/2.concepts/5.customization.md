...
When [`subNavigation`](/en/concepts/configuration#sub-navigation) is enabled, Docus renders a secondary navigation bar below the header. You can override it by creating a `components/AppHeaderBottom.vue` component.
