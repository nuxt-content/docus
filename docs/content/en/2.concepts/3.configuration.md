...
For documentation sites with many content sections, you can enable a secondary navigation bar below the header. It displays your top-level content folders as tabs and filters the left sidebar to show only the active section's pages.

![Sub navigation preview](/documentation/sub-navigation.png)
...
::prose-note
The sub navigation is only visible on desktop (`lg` breakpoint and above).
::
