...
Lorsque la [`subNavigation`](/fr/concepts/configuration#sous-navigation) est activée, Docus affiche une barre de navigation secondaire sous l'en-tête. Vous pouvez la surcharger en créant un composant `components/AppHeaderBottom.vue`.
