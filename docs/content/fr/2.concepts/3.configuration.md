...
Pour les sites de documentation avec de nombreuses sections, vous pouvez activer une barre de navigation secondaire sous l'en-tête. Elle affiche vos dossiers de premier niveau sous forme d'onglets et filtre la barre latérale gauche pour n'afficher que les pages de la section active.

![Aperçu de la sous-navigation](/documentation/sub-navigation.png)
...
::prose-note
La sous-navigation n'est visible que sur desktop (breakpoint `lg` et au-dessus).
::
