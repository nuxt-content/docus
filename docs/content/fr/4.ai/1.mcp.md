...
1. Ouvrez Cursor et allez dans **Settings** > **Tools & MCP**
2. Ajoutez la configuration du serveur MCP Docus
...
1. Ouvrez VS Code et accédez à la Palette de Commandes (`Ctrl/Cmd + Shift + P`)
2. Tapez "Preferences: Open Workspace Settings (JSON)" et sélectionnez-le
3. Naviguez vers le dossier `.vscode` de votre projet ou créez-le s'il n'existe pas
4. Créez ou modifiez le fichier `mcp.json` :
