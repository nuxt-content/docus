...
::prose-note
L'Assistant IA nécessite une clé API [AI Gateway](https://vercel.com/docs/ai-gateway) pour fonctionner.
::
...
Personnalisez les icônes utilisées par l'assistant IA :
