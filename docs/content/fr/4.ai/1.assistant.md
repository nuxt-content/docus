...
Utilisez le raccourci clavier <kbd value="meta">
...
export default defineAppConfig({
  assistant: {
    shortcuts: {
      // Par défaut : 'meta_i' (Cmd+I sur Mac, Ctrl+I on Windows)
...
<tbody>
  <tr>
    ...
    <td>
      Si le chat de l'assistant est activé (clé API présente)
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      Ouvrir l'assistant, optionnellement avec un message
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      Fermer le panneau de l'assistant
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      Basculer l'assistant ouvert/fermé
    </td>
  </tr>
