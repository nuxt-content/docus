...
::prose-note{to="/fr/concepts/edition#page-d-accueil"}
Vous pouvez personnaliser votre page d'accueil avec Markdown (`content/index.md`) ou créer une page Vue personnalisée (`app/pages/index.vue`). En savoir plus sur les options de page d'accueil.
::
