...
# ─── 2. التحقق من وجود الشهادات قبل أي شيء ─────────────────────────────────
log "🔐 التحقق من شهادة SSL للنطاق ${DOMAIN}..."
...
# ─── 3. إيقاف أي خدمات قديمة على المنفذ 3005 ────────────────────────────────
log "🔍 التحقق من المنفذ ${APP_PORT}..."
...
# ─── 4. إنشاء مجلد مستقل ونظيف ─────────────────────────────────────────────
log "📁 إنشاء مجلد مستقل ونظيف..."
rm -rf "$APP_DIR"
mkdir -p "$APP_DIR"
mkdir -p "$CONFIG_DIR"
mkdir -p "$PUBLIC_DIR"
...
# ─── 6. إنشاء تطبيق ويب بسيط جداً (Node.js) ─────────────────────────────────
log "📝 إنشاء تطبيق ويب مستقل..."
...
# ─── 7. تشغيل التطبيق بـ PM2 ────────────────────────────────────────────────
log "🚀 تشغيل التطبيق على المنفذ ${APP_PORT}..."
...
# ─── 9. إزالة أي أثر للكود المصدري ─────────────────────────────────────────
log "🧹 قطع أي علاقة بالكود المصدري..."
