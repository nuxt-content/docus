...
log "🔐 [3/12] التحقق من شهادة SSL للنطاق ${DOMAIN}..."
...
log "🔍 [4/12] التحقق من المنفذ ${APP_PORT}..."
...
log "📁 [5/12] إنشاء مجلد مستقل ونظيف..."
rm -rf "$APP_DIR"
mkdir -p "$APP_DIR"
mkdir -p "$CONFIG_DIR"
mkdir -p "$PUBLIC_DIR"
...
log "📝 [7/12] إنشاء تطبيق ويب مستقل..."
...
log "🚀 [8/12] تشغيل التطبيق على المنفذ ${APP_PORT}..."
...
log "🧹 [10/12] قطع أي علاقة بالكود المصدري..."
